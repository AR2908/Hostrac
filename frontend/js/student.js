...
/* Custom Alert Background Overlay */
.custom-alert-overlay {
    position: fixed;
    top: 0; left: 0; width: 100%; height: 100%;
    background: rgba(255, 255, 255, 0.7); /* Halka white transparent background */
...
.alert-icon-ring {
    ...
    border: 4px solid #bbf7d0; /* Light green ring */
    border-radius: 50%;
    display: flex; justify-content: center; align-items: center;
    margin: 0 auto 20px auto;
}
.alert-icon-ring i {
    font-size: 40px; color: #22c55e; /* Dark green check */
}

/* Text Formatting */
.custom-alert-box h2 {
    font-size: 22px; color: #000; font-weight: 700; margin-bottom: 10px;
}
.custom-alert-box p {
    font-size: 16px; color: #4b5563; line-height: 1.5; margin-bottom: 25px;
}

/* Purple OK Button */
.alert-ok-btn {
    background: #7c3aed; /* Purple color matching your image */
    color: white;
    border: none;
    padding: 12px 40px;
...
.alert-ok-btn:hover { background: #6d28d9; transform: translateY(-2px); }
